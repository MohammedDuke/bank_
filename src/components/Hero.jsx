...
const Hero = () => (
  <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
    <div className={`${styles.flexStart} flex-1 flex-col xl:px-0 p-6 sm:px-16`}>
      ...
      <p className={`${styles.paragraph} max-w-[470px] mt-t`}>
        Our team of experts uses a methodology to identify the cerdit cards most
    ...
    <div className={`flex-1 flex ${styles.flexCenter} md:my-0 relative my-10`}>
      ...
      <div className="absolute z-[0] w-[50%] h-[50%] botton-20 top-0 blue__gradient" />
    </div>
